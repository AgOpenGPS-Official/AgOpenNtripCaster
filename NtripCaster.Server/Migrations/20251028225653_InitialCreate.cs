...
namespace NtripCaster.Server.Migrations
{
    /// <inheritdoc />
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SourcePassword = table.Column<string>(type: "text", nullable: false),
                    ...
                    RequireClientAuthentication = table.Column<bool>(type: "boolean", nullable: false),
                    IsActive = table.Column<bool>(type: "boolean", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_NtripGroups", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LastPositionAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    Status = table.Column<int>(type: "integer", nullable: false),
                    LastStreamPauseAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ClientSessions_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.SetNull);
                    table.ForeignKey(
                        name: "FK_ClientSessions_MountPoints_MountPointId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_SourceConnections_MountPoints_MountPointId",
                        column: x => x.MountPointId,
                        principalTable: "MountPoints",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                name: "GroupMountPoints",
                columns: table => new
                {
                    AllowedGroupsId = table.Column<int>(type: "integer", nullable: false),
                    MountPointsId = table.Column<int>(type: "integer", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_GroupMountPoints", x => new { x.AllowedGroupsId, x.MountPointsId });
                    table.ForeignKey(
                        name: "FK_GroupMountPoints_MountPoints_MountPointsId",
                        column: x => x.MountPointsId,
                        principalTable: "MountPoints",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_GroupMountPoints_NtripGroups_AllowedGroupsId",
                        column: x => x.AllowedGroupsId,
                        principalTable: "NtripGroups",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_UserGroups_NtripGroups_GroupsId",
                        column: x => x.GroupsId,
                        principalTable: "NtripGroups",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ClientSessions_MountPointId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_GroupMountPoints_MountPointsId",
                table: "GroupMountPoints",
                column: "MountPointsId");

            migrationBuilder.CreateIndex(
                name: "IX_SourceConnections_MountPointId",

        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SourcePassword = table.Column<string>(type: "text", nullable: true),
                    LastGeneratedSourcePassword = table.Column<string>(type: "text", nullable: true),
                    SourcePasswordGeneratedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RtcmLatitude = table.Column<decimal>(type: "numeric", nullable: true),
                    RtcmLongitude = table.Column<decimal>(type: "numeric", nullable: true),
                    ReferenceStationId = table.Column<int>(type: "integer", nullable: true),
                    DetectedFormat = table.Column<string>(type: "text", nullable: true),
                    DetectedNavSystems = table.Column<string>(type: "text", nullable: true),
                    LastRtcmMessageTime = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    MessageCount = table.Column<int>(type: "integer", nullable: false),
                    BytesPerSecond = table.Column<int>(type: "integer", nullable: true),
